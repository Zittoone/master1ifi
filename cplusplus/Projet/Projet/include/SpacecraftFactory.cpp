...
{
	return new Elysium(gdb->getXCoordFor(x), gdb->getYCoordFor(y), 0.055, 0.055, 0.5, 30, 0.50, 125, 500, 0.09, 0.2, 1., environment);
}
...
{
	return new Nostromo(gdb->getXCoordFor(x), gdb->getYCoordFor(y), 0.075, 0.075, 0.3, 60, 0.8, 125, 1000, 0.9, 0.5, 0.1, environment);
}
