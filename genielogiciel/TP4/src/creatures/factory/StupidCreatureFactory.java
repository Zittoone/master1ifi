...
public class StupidCreatureFactory implements ICreatureFactory {
    @Override
    public List<ICreature> createCreatures(IEnvironment env, int number) {
        ...
        for (int i = 0; i < number; i++) {
            ...
            // speed
            int speed = (int) (rand.nextDouble() * CreatureBuilder.MAX_SPEED);
            ...
            list.add(new StupidCreature(env, new Point2D.Double(x,y), direction, speed, new Color(
                    r, g, b)));
        }
