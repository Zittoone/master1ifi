...
# (by Stefan.Manegold@cwi.nl, http://www.cwi.nl/~manegold/)
 ...
 set output 'calib.cache-replace-time.ps'
...
#set output 'calib.cache-replace-time.gif'
set data style linespoints
set key below
set title 'calib.cache-replace-time'
...
'calib.cache-replace-time.data' using 1:($7-0.000000) title '128' with linespoints lt 1 pt 3 , \
'calib.cache-replace-time.data' using 1:($13-0.000000) title '64' with linespoints lt 2 pt 4 , \
'calib.cache-replace-time.data' using 1:($19-0.000000) title '32' with linespoints lt 3 pt 5 , \
'calib.cache-replace-time.data' using 1:($25-0.000000) title '16' with linespoints lt 4 pt 6 , \
'calib.cache-replace-time.data' using 1:($31-0.000000) title '8' with linespoints lt 5 pt 7 , \
'calib.cache-replace-time.data' using 1:($37-0.000000) title '4' with linespoints lt 6 pt 8
set nolabel
set noarrow
